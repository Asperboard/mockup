...
function addQuestion() {
    ...
    if (!questionText || answers.length < 2 || correctAnswer < 0 || correctAnswer >= answers.length) {
        alert("Please enter a valid question with at least 2 answers and a correct answer index.");
        return;
    }
    ...
    alert("Question added! Add another or start the game.");
...
function startOver() {
    if (confirm("Are you sure you want to reset everything?")) {
        ...
        resetQuestionForm();
        alert("Quiz reset! Start adding new questions.");
    }
}
